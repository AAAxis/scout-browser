...
void AddStrings(content::WebUIDataSource* html_source,
  ...
  // Monti profile-picker group headers (session 22). Literal strings keep this
  // additive without touching the shared .grd resources.
  html_source->AddString("montiIdentitiesGroupLabel", u"Monti identities");
  html_source->AddString("googleProfilesGroupLabel", u"Google profiles");
