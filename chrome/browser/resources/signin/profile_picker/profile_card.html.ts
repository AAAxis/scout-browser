...
<div id="profileCardContainer"
    class="${this.profileState.isArgus ? 'argus-card' : ''}">
  <cr-button id="profileCardButton" @click="${this.onProfileClick_}"
    ...
    <div id="avatarContainer">
      ...
      <div id="statusDot" class="status-dot"
          ?hidden="${!this.profileState.isArgus || !this.profileState.running}">
      </div>
    </div>
    ...
    <div id="argusMeta" class="profile-card-info"
        ?hidden="${!this.profileState.isArgus}">
      <span class="argus-chip country-chip"
          ?hidden="${!this.profileState.proxyCountry}">
        ${this.profileState.proxyCountry}
      </span>
      <span class="argus-chip preset-chip"
          ?hidden="${!this.profileState.fingerprintPreset}">
        ${this.presetLabel_()}
      </span>
    </div>
