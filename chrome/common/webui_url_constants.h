...
inline constexpr char kChromeUIMontiSidePanelHost[] =
    "monti-side-panel.top-chrome";
inline constexpr char kChromeUIMontiSidePanelURL[] =
    "chrome://monti-side-panel.top-chrome/";
